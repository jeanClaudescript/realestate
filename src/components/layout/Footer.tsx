...
export function Footer() {
  ...
  return (
    ...
    <footer className="footer-surface" id="payments">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-10 sm:py-16 md:py-20 safe-bottom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-footer-muted max-w-sm leading-relaxed mb-6">{t('footer.tagline')}</p>
            ...
            <div className="space-y-3 text-sm text-footer-muted">
              ...
              <div className="flex items-center gap-2">
                ...
                <PhoneDisplay phone={formatRwandaPhone('788000000')} className="text-footer-muted hover:text-brand-charcoal dark:hover:text-white" />
          ...
          {columns.map((col) => (
            ...
            <div key={col.title}>
              ...
              <h4 className="font-semibold text-brand-gold-dark dark:text-brand-gold mb-4">{col.title}</h4>
                ...
                {col.links.map((link) => (
                  ...
                  <li key={link.href + link.label}>
                    ...
                    <Link
                      ...
                      className="text-footer-muted hover:text-brand-charcoal dark:hover:text-white text-sm transition-colors inline-block py-1"
        ...
        <div className="mt-12 sm:mt-16 pt-8 border-t border-subtle flex flex-col md:flex-row justify-between gap-4 text-sm text-footer-muted">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6">
            ...
            <Link to="/legal/privacy" className="hover:text-brand-charcoal dark:hover:text-white transition-colors">
              {t('footer.privacy')}
            </Link>
            <Link to="/legal/terms" className="hover:text-brand-charcoal dark:hover:text-white transition-colors">
              {t('footer.terms')}
            </Link>
            <Link to="/legal/compliance" className="hover:text-brand-charcoal dark:hover:text-white transition-colors">
              {t('footer.compliance')}
            </Link>
